...
public class AdministratorPensiune implements ICamera{
...
public AdministratorPensiune(Camera camera) {
	super();
	this.camera = camera;
	this.varsta = -1;
}
...
public AdministratorPensiune(String Cnp, String nume, String numar_telefon, String email) {
	super();
...
public boolean equals(AdministratorPensiune a) {
...
LinkedList<ICommand> comenziAdministrator = new LinkedList<ICommand>();

public void invoca(ICommand comanda){
	comenziAdministrator.add(comanda);
    comanda.executeCuratenie();
}

public void undo(){
	comenziAdministrator.pollLast().unexecuteCuratenie();
}
